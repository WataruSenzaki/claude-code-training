...
<div class="sheet">
  ...
  <div class="exit">
    <h2>&#128161; 楽にする入口（ここから直す）</h2>
    <!-- 差し替え: 楽にする入口 1〜2点。<b>いちばん暗黙</b> / <b>いちばん手間</b> の見出し付きで -->
    <ul>
      <li><b>いちばん暗黙</b>：「帳簿の未反映ぶんを記憶で拾う」&rarr; そもそも帳簿が即時反映されていれば、この確認作業ごと消える（属人の大半が解ける）</li>
      <li><b>いちばん手間</b>：残数の確認（最大30原料を一個一個照合）&rarr; 製造結果データと帳簿が即つながれば、繰り返しの照合が減る</li>
    </ul>
  </div>
</div>
</body>
...
### 4. 直したいと言われたら
図を直接いじらない。**`業務.md`（文章）を直して、もう一度このスキルで図にする**。正本はいつも文章＝view は何度でも作り直せる。
